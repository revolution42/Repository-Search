 ...
 *
 */
class Groups extends bbApiAbstract
{
	 ...
	 */
	public function add($group_name, $permission = Permission::read, $auto_add = false, $credential = null)
	{
		$this->checkUsername($credential);
		...
		{
			$response = $this->update($group_name, $permission, $auto_add, $group_name, $credential);
		}	
	 ...
	 */
	public function update($group_name, $permission = Permission::read, $auto_add = false, $new_name = null, $credential = null)
	{
		$this->checkUsername($credential);
		
		$this->checkPermission($permission);
		
		$new_name = $new_name ? null : $group_name;
 ...
 *
 */
class Members extends bbApiAbstract
{
